	...
	<form class="tab-content form-horizontal" role="form" id="contentForm">
	  <div role="tabpanel" class="tab-pane active" id="home">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		    	<?php echo D('ArticleCategory')->getSelectHtml('categoryID');?>
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-2">
		      <input type="text" class="form-control" name="createtime" placeholder="时间" value="<?php echo date('Y-m-d H:i:s',time());?>"
